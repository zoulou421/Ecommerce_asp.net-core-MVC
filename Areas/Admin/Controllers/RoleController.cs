...
namespace OnlineShop.Areas.Admin.Controllers
{
    ...
    public class RoleController : Controller
    {
        ...
        public async Task<IActionResult> Create(string name)
        {
            ...
            if (isExist)
            {
                ViewBag.messge = "This role is alrealdy exist";
                ViewBag.name = name;
                return View();
            }
        ...
        {
            //var user = _db.ApplicationUsers.FirstOrDefault(c => c.Id == roleUser.RoleId);
            ...
            {
                ViewBag.messge = "This User role assigned is alrealdy exists!";
                ViewData["UserId"] = new SelectList(_db.ApplicationUsers.Where(f => f.LockoutEnd < DateTime.Now || f.LockoutEnd == null).ToList(),  "Id", "UserName");
                ViewData["RoleId"] = new SelectList(_roleManager.Roles.ToList(), "Name", "Name");
                return View();
            }
